...
<<<<<<< HEAD
// func examplePathPayment(client *horizonclient.Client, mock bool) horizon.TransactionSuccess {
...
func submit(client *horizonclient.Client, txeBase64 string, mock bool) (resp horizon.TransactionSuccess) {
	if mock == true {
		resp = mockSuccess()
	} else {
		var err error
